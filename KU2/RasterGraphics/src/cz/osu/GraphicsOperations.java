...
public class GraphicsOperations {
    ...
    public static void drawTriangle(V_RAM vram, TriangleIn2D triangle, Point2D[] points ,int brightness){

        line(vram, new Line2D(points[triangle.pA], points[triangle.pB]), brightness);
        line(vram, new Line2D(points[triangle.pB], points[triangle.pC]), brightness);
        line(vram, new Line2D(points[triangle.pC], points[triangle.pA]), brightness);
    }

    public static void drawTriangle(V_RAM vram, Triangle3D triangle, Point3D[] points ,int brightness){

        line(vram, new Line2D(new Point2D(points[triangle.pA].data[0],points[triangle.pA].data[1]), new Point2D(points[triangle.pB].data[0],points[triangle.pB].data[1])), brightness);
        line(vram,  new Line2D(new Point2D(points[triangle.pB].data[0],points[triangle.pB].data[1]), new Point2D(points[triangle.pC].data[0],points[triangle.pC].data[1])), brightness);
        line(vram,  new Line2D(new Point2D(points[triangle.pC].data[0],points[triangle.pC].data[1]), new Point2D(points[triangle.pA].data[0],points[triangle.pA].data[1])), brightness);
    }
